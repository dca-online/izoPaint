  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ...
        className="px-6 py-3 bg-[#8a7d65] text-white rounded-full text-lg font-medium hover:bg-[#8a7d65]/80 transition-colors flex items-center"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 mt-2 z-40 overflow-hidden rounded-xl shadow-lg border border-[#8a7d65]/20 min-w-[240px]"
          >
            <div className="bg-white overflow-hidden">
              ...
              <div className="divide-y divide-gray-100">
                ...
                <button
                  ...
                  className={`w-full flex items-center gap-3 p-4 hover:bg-[#f8f8f6] transition-colors text-left group ${
                    currentCategory === 'izolații' ? 'bg-[#f8f8f6]' : ''
                  }`}
                >
