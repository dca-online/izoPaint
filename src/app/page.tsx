      ...
      <main className="min-h-screen bg-[#1A1A1A]">
        ...
        <section className="py-20 px-4 md:px-8 lg:px-16 bg-[#1A1A1A]">
          <div className="container mx-auto">
            ...
            >
              <h2 className="text-4xl md:text-6xl font-bold text-white max-w-5xl text-left mb-6">
            ...
            <div className="mb-16">
              <motion.h3 
                className="text-2xl font-bold text-[#B99C4B] mb-8"
            ...
            <div>
              <motion.h3 
                className="text-2xl font-bold text-[#F0E4B2] mb-8"
                initial={{ opacity: 0, x: -50 }}
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                transition={{ duration: 0.6 }}
        ...
        <section className="py-20 px-4 md:px-8 lg:px-16 bg-[#333333] relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full opacity-10">
            <div className="absolute top-20 right-20 w-80 h-80 rounded-full bg-[#B99C4B] blur-3xl" />
            <div className="absolute bottom-20 left-20 w-80 h-80 rounded-full bg-[#F0E4B2] blur-3xl" />
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="mb-6 md:mb-0">
                <h3 className="text-xl font-bold text-white mb-2">
                  <span className="text-[#B99C4B]">Vopsele</span> & <span className="text-[#F0E4B2]">Izolații</span>
                </h3>
              ...
              <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
                <a href="#" className="text-white/80 hover:text-[#B99C4B] transition-colors">
                  Acasă
                </a>
                <a href="#" className="text-white/80 hover:text-[#B99C4B] transition-colors">
                  Servicii
